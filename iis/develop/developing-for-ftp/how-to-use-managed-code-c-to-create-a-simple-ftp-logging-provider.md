---
title: "How to Use Managed Code (C#) to Create a Simple FTP Logging Provider"
author: rmcmurray
...
ms.date: 03/18/2009
ms.assetid: 4aa9b606-324d-49da-bc2d-45927fe89698
...
2. Add the extensibility provider to the global list of FTP providers: 
    ...
    - Enter the assembly information for the extensibility provider using the information that you copied earlier. For example:
        ...
        [!code-console[Main](how-to-use-managed-code-c-to-create-a-simple-ftp-logging-provider/samples/sample3.cmd)]
    - Click **OK**.
