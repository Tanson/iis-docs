...
2. Type the following command: 
   ...
   - For native 64 bit <em>*- `%WINDIR%\system32\regsvr32.exe <</em>providerdllname<em>.dll>` where *providerdllname</em>.dll is the provider dll.
...
**Web Playlists Extensibility Support**. View the Web Playlists Programming Reference and Programming Guide on the [Microsoft Developer Network (MSDN)](https://msdn.microsoft.com/library/dd146275.aspx).
